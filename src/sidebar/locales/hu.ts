...
export const hu: Translation = {
    ...
    anthropicDescription: 'Beszélgess közvetlenül a Claude-dal a hivatalos Anthropic API-n keresztül.',
    ...
    anthropicApiKey: 'Anthropic API kulcs',
    anthropicApiKeyPlaceholder: 'sk-ant-...',
    anthropicApiKeyHint: 'A Claude hívására szolgál az api.anthropic.com címen keresztül. Helyileg, az eszközödön tárolódik.',
    ...
    anthropicGetKeyNotice: 'Kulcsot a console.anthropic.com → Settings → API Keys oldalon szerezhetsz. „sk-ant-" kezdetű.',
    ...
    imageGenClaudeSvgHint: 'A Claude SVG-illusztrációt rajzol, amelyet a böngésző PNG-vé alakít.',
