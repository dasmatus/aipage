...
export const de: Translation = {
    ...
    anthropicDescription: 'Chatte direkt mit Claude über die offizielle Anthropic-API.',
    ...
    anthropicApiKeyHint: 'Wird verwendet, um Claude über api.anthropic.com aufzurufen. Lokal auf deinem Gerät gespeichert.',
    ...
    anthropicGetKeyNotice: 'Schlüssel erhältst du auf console.anthropic.com → Settings → API Keys. Er beginnt mit „sk-ant-".',
    ...
    imageGenClaudeSvgHint: 'Claude zeichnet eine SVG-Illustration, die im Browser in ein PNG umgewandelt wird.',
